...
Defines the behaviour of the home dashboard's "🔒 Next bet locks in" countdown: which deadline it tracks (the next un-bet match's kickoff vs. the special-bets close), how its match label/target stay consistent with the featured-match card, and when the countdown section is shown or hidden.
