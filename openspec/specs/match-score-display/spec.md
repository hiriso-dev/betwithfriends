...
Defines how match scores are presented across the app's views (home, fixtures, match detail, history, match cards), including how missing-but-expected scores are shown while the football-data sync catches up.
